...
const KitchenPage: React.FC<Props> = ({ demo }) => {
    ...
    return (
        <MemberPage title="Dapur & Perencanaan Menu" parentLabel="Dapur">
            <Row className="g-4">
                <Col lg={8}>
...
(KitchenPage as any).layout = (page: React.ReactNode) => <TenantMemberLayout>{page}</TenantMemberLayout>;
